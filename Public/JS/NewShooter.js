...
function preload ()
{
    ...
    this.load.image('player_handgun', 'assets/Player/Knight.png');
    this.load.image('bullet', 'assets/long-sword.png');
...
function create ()
{
    ...
    this.input.on('pointerdown', function (pointer, time, lastFired) {
        ...
        var bullet = playerBullets.get().setActive(true).setVisible(true).setScale(0.25);
